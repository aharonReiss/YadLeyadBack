...
insert into LevelsForCategories values (N'פרטי הנכס',1,'18,3,4,5,6,16,17,7,10,9,11,12,13,14,19,20,8');
insert into LevelsForCategories values (N'פרטי התקשרות',1,'21,22');

insert into LevelsForCategories values (N'כתובת הנכס',2,'1,2');
insert into LevelsForCategories values (N'פרטי הנכס',2,'18,3,4,5,6,16,17,7,10,9,12,14,19,11,13,20,23');
